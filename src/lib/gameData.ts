...
const gameInfos: {[key: string]: [string, string, boolean]} = {
  ...
  "jumpyManOnline": ["Jumpy Man (Online Multiplayer)", "<p>You are the red box (P1) or blue box (P2).<br/>Avoid the green boxes.<br/><br/><u>Controls:</u> W, A, D.<br/><br/>The goal is to last longer than the opponent.<u>Controls for P1:</u> W, A, D.<br/><u>Controls for P2:</u> left, right and up arrow keys.</p>", true],
  "platformShooters": ["Platform Shooters", "<p>Shoot the other player and get the higher score.<br/></p>", false]
}
